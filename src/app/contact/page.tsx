          ...
          <div className="grid lg:grid-cols-5 gap-16">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                <p className="text-navy/70 mb-4 text-center">Or message us directly on WhatsApp for a faster response</p>
                <a
                  href="https://wa.me/447544886142?text=Hi%2C%20I%27d%20like%20to%20request%20a%20quote%20for%20cleaning%20services."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-3 w-full py-4 rounded-full bg-[#25D366] text-white font-bold tracking-wide uppercase hover:bg-[#20bd5a] transition-colors"
                >
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-navy/60 text-sm">Everyday: 9:00 AM – 10:00 PM</p>
                  </div>
                </div>
